...
<div class="tabbable">
    ...
    <ul class="nav nav-tabs">
        <li class="active"><a href="#installed" data-toggle="tab"><?php echo __('Installed', 'plugins'); ?> <?php if(count($_users_plugins) > 0) { ?><span class="badge"><?php echo count($_users_plugins); ?></span><?php } ?></a></li>
